...
namespace ImageViewer.Infrastructure.Migrations
{
    ...
    [Migration("20251001153815_InitialCreate")]
            ...
            modelBuilder.Entity("ImageViewer.Domain.Entities.Collection", b =>
                {
                    ...
                    b.Property<CollectionSettings>("Settings")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("ImageViewer.Domain.Entities.Image", b =>
                {
                    ...
                    b.Property<ImageMetadata>("Metadata")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("ImageViewer.Domain.Entities.ViewSession", b =>
                {
                    ...
                    b.Property<ViewSessionSettings>("Settings")
                        .IsRequired()
                        .HasColumnType("jsonb");
